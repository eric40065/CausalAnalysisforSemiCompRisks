...
# simulation(1, hypo = 'null') # Run this line to get the same result in our paper.
# simulation(1, hypo = 'alter') # Run this line to get the same result in our paper.
...
# simulation(2, 'null') # Run this line to get the same result in our paper.
# simulation(2, 'alter') # Run this line to get the same result in our paper.
```
### REVEAL-HBV
```r
library(CausalAnalysisforSemiCompRisks)
