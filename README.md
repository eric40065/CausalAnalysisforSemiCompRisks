...
## Usage
The following code can reproduce everything mentioned in our paper. It will take around five hours to reproduce Figure 1 and 2 and around 3 weeks (estimated) on a single-core machine to reproduce Table 1.
```r
